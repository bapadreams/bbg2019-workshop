...
namespace Gamekit2D
{
    ...
    public class PlayerCharacter : MonoBehaviour
    {
        ...
        void CheckInput()
        {
            ...
            CheckForHoldingGun();
            CheckAndFireGun();
            if (CheckForJumpInput() && m_CharacterController2D.IsGrounded)
                SetVerticalMovement(jumpSpeed);
            else if (CheckForMeleeAttackInput())
                MeleeAttack();
        }
        ...
        protected void UpdateCameraFollowTargetPosition()
        {
            ...
            cameraFollowTarget.localPosition = new Vector3(newLocalPosX, newLocalPosY, cameraFollowTarget.transform.position.z);
        }
        ...
        public void GroundedHorizontalMovement(bool useInput, float speedScale = 1f)
        {
            ...
            //Debug.Log( "desiredSeep " + desiredSpeed.ToString() + " , acceleration " + acceleration.ToString() +  " ,  Move " + m_MoveVector.ToString());
        }
