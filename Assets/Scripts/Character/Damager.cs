...
namespace Gamekit2D
{
    public class Damager : MonoBehaviour
    {
        ...
        [Tooltip("If damager is static")]
        public bool StaticDamager;
        ...
        private void OnTriggerEnter2D(Collider2D collision)
        {
            ...
            //int hitCount = Physics2D.OverlapArea(pointA, pointB, m_AttackContactFilter, m_AttackOverlapResults);
            if (!m_AttackContactFilter.IsFilteringLayerMask( collision.gameObject))
            {
                m_LastHit = collision;
        ...
        private void OnDrawGizmosSelected()
        {
            ...
            Gizmos.DrawCube(new Vector3(pointA.x, pointA.y, 1), new Vector3(scaledSize.x, scaledSize.y, 1));
