...
namespace Gamekit2D
{
    ...
    public class EnemyBehaviour : MonoBehaviour
    {
        ...
        /// <summary>
        /// retrived from State Machine (ChomperPatrolSMB)
        /// </summary>
        ...
        {
            forwardDistance = .1f;
            Debug.DrawLine(m_Collider.bounds.center, m_Collider.bounds.center + new Vector3(0, m_Collider.bounds.extents.y - 0.2f, 0), Color.red);
            Debug.DrawLine(m_Collider.bounds.center, m_Collider.bounds.center + new Vector3(0, -(m_Collider.bounds.extents.y - 0.2f), 0), Color.red);
            Debug.DrawLine(m_Collider.bounds.center, m_Collider.bounds.center + new Vector3(-(m_Collider.bounds.extents.y - 0.2f), 0, 0), Color.red);
            Debug.DrawLine(m_Collider.bounds.center, m_Collider.bounds.center + new Vector3(m_Collider.bounds.extents.y - 0.2f, 0, 0), Color.red);
        ...
        private void OnDrawGizmosSelected()
        {
            ...
            Handles.color = new Color(1.0f, 0, 0, 0.1f);
            //if (Physics2D.CircleCast(m_Collider.bounds.center, m_Collider.bounds.extents.y - 0.2f, m_SpriteForward, forwardDistance, m_Filter.layerMask.value))
            Handles.DrawSolidDisc(m_Collider.bounds.center, Vector3.back, m_Collider.bounds.extents.y - 0.2f);
            Handles.color = new Color(1.0f, .5f, 0, 0.1f);
            Handles.DrawSolidDisc(m_Collider.bounds.center + new Vector3(m_SpriteForward.x, m_SpriteForward.y), Vector3.back, m_Collider.bounds.extents.y - 0.2f);
